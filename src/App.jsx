...
export default function App() {
  ...
  if (view === 'home') return <main className="page"><section className="card landing-card"><Logo /><h1 className="tagline">Simulasi UTBK 2026. Pilih Jurusan dengan Data.</h1><p className="lead">Kerjakan tryout bergaya UTBK-SNBT lengkap: TPS, Literasi Bahasa Indonesia, Literasi Bahasa Inggris, dan Penalaran Matematika. Sistem menghitung estimasi skor 200-800, membaca kekuatan subtes, lalu menampilkan peta kelayakan jurusan USK berdasarkan target kompetitif.</p><div className="info-panel"><h2>Struktur Tryout</h2><ul><li><span>✓</span><p>{TOTAL} soal bergaya UTBK-SNBT 2026</p></li><li><span>✓</span><p>Durasi simulasi {TOTAL_MINUTES} menit dengan timer</p></li><li><span>✓</span><p>7 subtes: PU, PPU, PBM, PK, LBI, LBE, dan PM</p></li><li><span>✓</span><p>Peta jurusan memakai target skor, rasio persaingan, dan kategori Aman/Realistis/Ambisius/Berat</p></li></ul><SectionGrid /></div><button className="primary-btn home-btn" onClick={startTryout}>Mulai Tryout <ArrowRight size={38} /></button></section></main>;
